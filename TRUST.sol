...
contract TrustCoin is TRC20Token {

  constructor() public {
    initialSupply = 1000000000000000000000000000000000000000000000;
    name = "Trust Coin";
    symbol = "TC";
    decimals = 10;
    totalSupply = initialSupply * 1000000000000000000 ** uint256(decimals);
